...
- Helper scripts: `config_status.py`, `preflight.py`, `style_utils.py`, `update_config.py`, `prepare_audio_script.py`, `generate_audio.py`, `record_report.py`, `history_status.py`, `audit_log.py`
